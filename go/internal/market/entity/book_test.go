...
func TestBuyPartialAsset(t *testing.T) {
	...
	assert.Equal(15.0, float64(book.Transaction[0].TotalPrice), "Transaction should have price 15")
	assert.Equal(10.0, float64(book.Transaction[1].TotalPrice), "Transaction should have price 10")
}
